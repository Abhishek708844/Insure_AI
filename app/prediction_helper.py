...
# Use forward slashes or Pathlib for cross-platform compatibility
base_path = Path(__file__).parent / "artifacts"

model_young = joblib.load(base_path / "model_young.joblib")
model_rest = joblib.load(base_path / "model_rest.joblib")
scaler_young = joblib.load(base_path / "scaler_young.joblib")
scaler_rest = joblib.load(base_path / "scaler_rest.joblib")
